...
func (*MsgUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_b596337e43bd201c, []int{0}
}
...
func (*MsgUpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_b596337e43bd201c, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgUpdateParams)(nil), "josechain.josechain.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "josechain.josechain.MsgUpdateParamsResponse")
}

func init() { proto.RegisterFile("josechain/josechain/tx.proto", fileDescriptor_b596337e43bd201c) }

var fileDescriptor_b596337e43bd201c = []byte{
	// 318 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0xc9, 0xca, 0x2f, 0x4e,
	...
	0xab, 0xa4, 0x58, 0x1b, 0x40, 0xde, 0x71, 0x32, 0x3d, 0xf1, 0x48, 0x8e, 0xf1, 0xc2, 0x23, 0x39,
	0xc6, 0x07, 0x8f, 0xe4, 0x18, 0x27, 0x3c, 0x96, 0x63, 0xb8, 0xf0, 0x58, 0x8e, 0xe1, 0xc6, 0x63,
	0x39, 0x86, 0x28, 0x69, 0xec, 0xbe, 0x29, 0xa9, 0x2c, 0x48, 0x2d, 0x4e, 0x62, 0x03, 0x47, 0x88,
	0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x5b, 0x05, 0x38, 0xc4, 0x44, 0x02, 0x00, 0x00,
}
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/josechain.josechain.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/josechain.josechain.Msg/UpdateParams",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "josechain.josechain.Msg",
	...
	Metadata: "josechain/josechain/tx.proto",
}
